...
<div class="container-fluid p-4 h-100 bg-white">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <h1 class="h4 text-gray-800">Laporan Seleksi Diproses <span class="d-block font-weight-normal" style="font-size: 14px;">Cetak data laporan</span></h1>
    <div class="d-flex justify-content-end">
      <div>
        <a href="laporan-seleksi-diproses.php?page=cetak" class="btn btn-danger" target="_blank"><i class="fas fa-file-pdf"></i> Cetak</a>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="laporan-seleksi-diproses.php?page=export" method="get" id="print" target="_blank">
