...
?>
  ...
  <body>
    ...
    <br>
    <h2 style="text-align: center; font-size:16px;">Laporan Seleksi Diproses
    </h2>
    <br>
    <table class="table">
      <colgroup>
...
JOIN bidang_pekerjaan 
    ...
    WHERE rekrutmen.status = 'diproses' AND MONTH(rekrutmen.tanggal) = '$bulan' AND YEAR(rekrutmen.tanggal) = '$tahun'
