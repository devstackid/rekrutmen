...
<div class="container-fluid p-4 h-100 bg-white">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <h1 class="h4 text-gray-800">Laporan Seleksi Ditolak <span class="d-block font-weight-normal" style="font-size: 14px;">Cetak data laporan</span></h1>
    <div class="d-flex justify-content-end">
      <div>
        <a href="laporan-seleksi-ditolak.php?page=cetak" class="btn btn-danger" target="_blank"><i class="fas fa-file-pdf"></i> Cetak</a>
...
";
            ...
            ?>
              <tr>
                ...
                <td class="text-nowrap"><?= format_date($row['updated_at']); ?></td>
                <td><?= $row['catatan']; ?></td>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="laporan-seleksi-ditolak.php?page=export" method="get" id="print" target="_blank">
