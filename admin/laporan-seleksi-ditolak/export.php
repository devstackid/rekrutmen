...
?>
  ...
  <body>
    ...
    <br>
    <h2 style="text-align: center; font-size:16px;">Laporan Seleksi Ditolak
    </h2>
    <br>
    <table class="table">
      <colgroup>
...
JOIN bidang_pekerjaan 
    ...
    WHERE rekrutmen.status = 'ditolak' AND MONTH(rekrutmen.tanggal) = '$bulan' AND YEAR(rekrutmen.tanggal) = '$tahun'
