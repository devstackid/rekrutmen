...
<div class="container-fluid p-4 h-100 bg-white">
  ...
  <div class="d-flex align-items-center justify-content-between">
    <h1 class="h4 text-gray-800">Laporan Kategori Pembelian <span class="d-block font-weight-normal" style="font-size: 14px;">Cetak data laporan</span></h1>
    <!-- <a href="activities.php?page=tambah" class="btn btn-primary">Tambah</a> -->
    <div class="d-flex justify-content-end">
      <div>
        <a href="laporan-penjualan-kategori.php?page=export" class="btn btn-danger" target="_blank"><i class="fas fa-file-pdf"></i> Cetak</a>
  ...
  <div class="card card-body border-0 p-0 mt-2">
    <div class="row">
      ...
      FROM kategori k
      JOIN katalog p ON k.id = p.kategori_id
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="laporan-penjualan-kategori.php?page=exportbulan" method="get" id="print" target="_blank">
